...
let taskManagerJSON = """
{
  ...
  "styles": {
    ...
    "statsValue": { "fontSize": 28, "fontWeight": "bold", "textColor": "#007AFF" },
    "statsLabel": { "fontSize": 12, "textColor": "#8E8E93" },
    "statsCard": {
      "backgroundColor": "#F2F2F7", "cornerRadius": 16,
      "padding": { "all": 16 }
    },
    ...
    "taskTitleCompleted": { "fontSize": 16, "textColor": "#8E8E93" },
    "priorityHigh": {
  ...
  "actions": {
    ...
    "addTask": {
      "type": "sequence",
      "steps": [
        { "type": "appendToArray", "path": "tasks", "value": {
          "id": { "$expr": "${tasks.count} + 1" },
          "title": { "$expr": "${newTaskTitle}" },
          "completed": false,
          "priority": "medium"
        }},
        { "type": "setState", "path": "newTaskTitle", "value": "" }
      ]
    },
    "setFilterAll": { "type": "setState", "path": "filter", "value": "all" },
    "setFilterActive": { "type": "setState", "path": "filter", "value": "active" },
    "setFilterDone": { "type": "setState", "path": "filter", "value": "done" },
    "toggleShowCompleted": { "type": "toggleState", "path": "showCompleted" },
    "clearCompleted": {
      "type": "showAlert",
  ...
  "dataSources": {
    "totalTasks": { "type": "binding", "template": "${tasks.count}" },
    "taskSummary": { "type": "binding", "template": "${tasks.count} tasks total" }
  },
  "root": {
    "backgroundColor": "#FFFFFF",
    "edgeInsets": { "top": 20 },
    "children": [{
      ...
      "sections": [
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    { "type": "label", "dataSourceId": "taskSummary", "styleId": "subtitle" }
                  ]
                },
                { "type": "spacer" },
                {
        ...
        },
        {
          ...
          "children": [
            {
              "type": "vstack", "alignment": "center", "styleId": "statsCard",
              "children": [
                { "type": "label", "dataSourceId": "totalTasks", "styleId": "statsValue" },
                { "type": "label", "text": "Total", "styleId": "statsLabel" }
              ]
            },
            {
              "type": "vstack", "alignment": "center", "styleId": "statsCard",
              "children": [
                { "type": "label", "text": "2", "styleId": "statsValue" },
                { "type": "label", "text": "Active", "styleId": "statsLabel" }
              ]
            },
            {
              "type": "vstack", "alignment": "center", "styleId": "statsCard",
              "children": [
                { "type": "label", "text": "1", "styleId": "statsValue" },
                { "type": "label", "text": "Done", "styleId": "statsLabel" }
              ]
            }
          ]
        },
              ...
              "children": [
                {
                  ...
                  "styles": { "normal": "filterButton", "selected": "filterButtonSelected" },
                  "isSelectedBinding": "${filter == 'all'}",
                  "actions": { "onTap": "setFilterAll" }
                },
                {
                  "type": "button", "text": "Active",
                  "styles": { "normal": "filterButton", "selected": "filterButtonSelected" },
                  "isSelectedBinding": "${filter == 'active'}",
                  "actions": { "onTap": "setFilterActive" }
                },
                {
                  "type": "button", "text": "Done",
                  "styles": { "normal": "filterButton", "selected": "filterButtonSelected" },
                  "isSelectedBinding": "${filter == 'done'}",
                  "actions": { "onTap": "setFilterDone" }
                },
                { "type": "spacer" },
                { "type": "button", "text": "Clear Done", "styleId": "filterButton", "actions": { "onTap": "clearCompleted" } }
              ]
            }
          ]
        },
        {
          "id": "task-list",
          "layout": { "type": "list", "showsDividers": true, "contentInsets": { "horizontal": 20 } },
          "header": { "type": "label", "text": "Your Tasks", "styleId": "sectionHeader", "padding": { "bottom": 8 } },
          "children": [
            {
              "type": "hstack", "styleId": "taskRow",
              "children": [
                { "type": "image", "image": { "system": "circle" }, "styleId": "checkboxEmpty" },
                {
                  "type": "vstack", "spacing": 4, "alignment": "leading", "padding": { "leading": 12 },
                  "children": [
                    { "type": "label", "text": "Review pull requests", "styleId": "taskTitle" },
                    { "type": "label", "text": "HIGH", "styleId": "priorityHigh" }
                  ]
                },
                { "type": "spacer" },
                { "type": "image", "image": { "system": "trash" }, "styleId": "deleteButton" }
              ]
            },
            {
              "type": "hstack", "styleId": "taskRow",
              "children": [
                { "type": "image", "image": { "system": "checkmark.circle.fill" }, "styleId": "checkboxFilled" },
                {
                  "type": "vstack", "spacing": 4, "alignment": "leading", "padding": { "leading": 12 },
                  "children": [
                    { "type": "label", "text": "Update documentation", "styleId": "taskTitleCompleted" },
                    { "type": "label", "text": "MEDIUM", "styleId": "priorityMedium" }
                  ]
                },
                { "type": "spacer" },
                { "type": "image", "image": { "system": "trash" }, "styleId": "deleteButton" }
            ...
            },
            {
              ...
              "children": [
                { "type": "image", "image": { "system": "circle" }, "styleId": "checkboxEmpty" },
                {
                  "type": "vstack", "spacing": 4, "alignment": "leading", "padding": { "leading": 12 },
                  "children": [
                    { "type": "label", "text": "Fix login bug", "styleId": "taskTitle" },
                    { "type": "label", "text": "HIGH", "styleId": "priorityHigh" }
                  ]
                },
                { "type": "spacer" },
            ...
            },
            {
              ...
              "children": [
                { "type": "image", "image": { "system": "circle" }, "styleId": "checkboxEmpty" },
                {
                  "type": "vstack", "spacing": 4, "alignment": "leading", "padding": { "leading": 12 },
                  "children": [
                    { "type": "label", "text": "Write unit tests", "styleId": "taskTitle" },
                    { "type": "label", "text": "LOW", "styleId": "priorityLow" }
                  ]
                },
                { "type": "spacer" },
                { "type": "image", "image": { "system": "trash" }, "styleId": "deleteButton" }
...
let profileEditorJSON = """
{
  ...
  "state": {
    ...
    "username": "@alexj",
    "bio": "iOS Developer | Coffee enthusiast | Building cool stuff",
  ...
  "styles": {
    "screenTitle": { "fontSize": 28, "fontWeight": "bold", "textColor": "#000000" },
    "avatarContainer": {
      "width": 100, "height": 100, "backgroundColor": "#007AFF", "cornerRadius": 50
    },
    "avatarText": { "fontSize": 36, "fontWeight": "bold", "textColor": "#FFFFFF" },
    "changePhotoButton": { "fontSize": 14, "fontWeight": "medium", "textColor": "#007AFF" },
    "sectionHeader": { "fontSize": 13, "fontWeight": "semibold", "textColor": "#8E8E93" },
    "fieldLabel": { "fontSize": 14, "textColor": "#8E8E93" },
    "fieldValue": { "fontSize": 16, "textColor": "#000000" },
    "inputField": {
      "fontSize": 16, "textColor": "#000000",
      "backgroundColor": "#F2F2F7", "cornerRadius": 10,
      "padding": { "horizontal": 14, "vertical": 12 }
    ...
    "bioField": {
      "fontSize": 16, "textColor": "#000000",
      "backgroundColor": "#F2F2F7", "cornerRadius": 10,
      "padding": { "all": 14 }, "height": 80
    },
    "charCount": { "fontSize": 12, "textColor": "#8E8E93" },
    "settingRow": { "padding": { "vertical": 8 } },
    "settingLabel": { "fontSize": 16, "textColor": "#000000" },
    "settingDescription": { "fontSize": 13, "textColor": "#8E8E93" },
    "saveButton": {
      "fontSize": 17, "fontWeight": "semibold",
      "backgroundColor": "#007AFF", "textColor": "#FFFFFF",
      "cornerRadius": 12, "height": 50
    },
    "saveButtonDisabled": {
      "fontSize": 17, "fontWeight": "semibold",
      "backgroundColor": "#C7C7CC", "textColor": "#FFFFFF",
      "cornerRadius": 12, "height": 50
    },
    "cancelButton": {
      "fontSize": 17, "fontWeight": "medium",
      "backgroundColor": "#F2F2F7", "textColor": "#FF3B30",
      "cornerRadius": 12, "height": 50
    },
    "previewCard": {
      "backgroundColor": "#F8F8F8", "cornerRadius": 16,
    ...
    "previewTitle": { "fontSize": 12, "fontWeight": "semibold", "textColor": "#8E8E93" },
    "previewName": { "fontSize": 20, "fontWeight": "bold", "textColor": "#000000" },
    "previewUsername": { "fontSize": 14, "textColor": "#007AFF" },
    "previewBio": { "fontSize": 14, "textColor": "#333333" },
    "badge": {
      "fontSize": 10, "fontWeight": "bold",
      "backgroundColor": "#34C759", "textColor": "#FFFFFF",
      "cornerRadius": 4, "padding": { "horizontal": 6, "vertical": 2 }
  ...
  "actions": {
    ...
    "save": {
      "type": "sequence",
      "steps": [
        { "type": "setState", "path": "hasChanges", "value": false },
        {
          "type": "showAlert",
    ...
    "changePhoto": {
      ...
      "buttons": [
        { "label": "Camera", "style": "default" },
        { "label": "Photo Library", "style": "default" },
        { "label": "Cancel", "style": "cancel" }
      ]
    },
    "markChanged": { "type": "setState", "path": "hasChanges", "value": true }
  },
  "dataSources": {
    "displayNamePreview": { "type": "binding", "template": "${displayName}" },
    "usernamePreview": { "type": "binding", "template": "${username}" },
    "bioPreview": { "type": "binding", "template": "${bio}" },
    "visibilityStatus": { "type": "binding", "template": "${isPublic ? 'Public Profile' : 'Private Profile'}" }
  },
  "root": {
    "backgroundColor": "#F2F2F7",
    "edgeInsets": { "top": 20 },
    "children": [{
      ...
      "sections": [
          ...
          "children": [
            {
              "type": "hstack",
              "children": [
                { "type": "label", "text": "Edit Profile", "styleId": "screenTitle" },
                { "type": "spacer" },
                {
                  "type": "button",
                  "actions": { "onTap": "close" },
        ...
        },
        {
          ...
          "children": [
            {
              "type": "vstack", "spacing": 12, "alignment": "center", "styleId": "cardSection",
              "children": [
                {
                  "type": "zstack", "styleId": "avatarContainer",
                  "children": [
                    { "type": "label", "text": "AJ", "styleId": "avatarText" }
                  ]
                },
                { "type": "button", "text": "Change Photo", "styleId": "changePhotoButton", "actions": { "onTap": "changePhoto" } }
              ]
            }
          ]
        },
        {
          ...
          "children": [
            {
              "type": "vstack", "spacing": 16, "styleId": "cardSection",
              "children": [
                { "type": "label", "text": "BASIC INFORMATION", "styleId": "sectionHeader" },
                {
                  "type": "vstack", "spacing": 6, "alignment": "leading",
                  "children": [
                    { "type": "label", "text": "Display Name", "styleId": "fieldLabel" },
                    { "type": "textfield", "styleId": "inputField", "bind": "displayName" }
                  ]
                },
                {
                  "type": "vstack", "spacing": 6, "alignment": "leading",
                  "children": [
                    { "type": "label", "text": "Username", "styleId": "fieldLabel" },
                    { "type": "textfield", "styleId": "inputField", "bind": "username" }
                  ]
                },
                {
                  "type": "vstack", "spacing": 6, "alignment": "leading",
                  "children": [
                    { "type": "label", "text": "Bio", "styleId": "fieldLabel" },
                    { "type": "textfield", "placeholder": "Tell us about yourself...", "styleId": "bioField", "bind": "bio" }
                  ]
                }
              ]
            }
          ...
          "children": [
            {
              "type": "vstack", "spacing": 16, "styleId": "cardSection",
              "children": [
                { "type": "label", "text": "CONTACT", "styleId": "sectionHeader" },
                {
                  "type": "vstack", "spacing": 6, "alignment": "leading",
                  "children": [
                    { "type": "label", "text": "Email", "styleId": "fieldLabel" },
                    { "type": "textfield", "styleId": "inputField", "bind": "email" }
                  ]
                },
                {
                  "type": "vstack", "spacing": 6, "alignment": "leading",
                  "children": [
                    { "type": "label", "text": "Website", "styleId": "fieldLabel" },
                    { "type": "textfield", "placeholder": "yoursite.com", "styleId": "inputField", "bind": "website" }
                  ]
                }
              ]
            }
          ...
          "children": [
            {
              "type": "vstack", "spacing": 16, "styleId": "cardSection",
              "children": [
                { "type": "label", "text": "PRIVACY", "styleId": "sectionHeader" },
                {
                  "type": "hstack", "styleId": "settingRow",
                  "children": [
                    {
                      "type": "vstack", "spacing": 2, "alignment": "leading",
                      "children": [
                        { "type": "label", "text": "Public Profile", "styleId": "settingLabel" },
                        { "type": "label", "text": "Anyone can view your profile", "styleId": "settingDescription" }
                      ]
                    },
                    { "type": "spacer" },
                    { "type": "toggle", "bind": "isPublic", "styleId": "greenToggle" }
                  ]
                },
                {
                  "type": "hstack", "styleId": "settingRow",
                  "children": [
                    {
                      "type": "vstack", "spacing": 2, "alignment": "leading",
                      "children": [
                        { "type": "label", "text": "Show Email", "styleId": "settingLabel" },
                        { "type": "label", "text": "Display email on your profile", "styleId": "settingDescription" }
                      ]
                    },
                    { "type": "spacer" },
                    { "type": "toggle", "bind": "showEmail", "styleId": "greenToggle" }
                  ]
                }
              ]
            }
        ...
        },
        {
          ...
          "children": [
            {
              "type": "vstack", "spacing": 12, "styleId": "previewCard",
              "children": [
                { "type": "label", "text": "PROFILE PREVIEW", "styleId": "previewTitle" },
                {
                      ...
                      "children": [
                        {
                          "type": "hstack", "spacing": 8,
                          "children": [
                            { "type": "label", "dataSourceId": "displayNamePreview", "styleId": "previewName" },
                            { "type": "label", "dataSourceId": "visibilityStatus", "styleId": "badge" }
                          ]
                        },
                        { "type": "label", "dataSourceId": "usernamePreview", "styleId": "previewUsername" },
                        { "type": "label", "dataSourceId": "bioPreview", "styleId": "previewBio" }
                      ]
                    }
                  ]
                }
        ...
        {
          "id": "actions",
          "layout": { "type": "list", "showsDividers": false, "itemSpacing": 12, "contentInsets": { "horizontal": 20, "bottom": 40 } },
          "children": [
            { "type": "button", "text": "Save Changes", "styleId": "saveButton", "fillWidth": true, "actions": { "onTap": "save" } },
            { "type": "button", "text": "Cancel", "styleId": "cancelButton", "fillWidth": true, "actions": { "onTap": "cancel" } }
          ]
        }
      ]
    }]
